    ...
    public class StoreController : BaseController<ProductViewModel, ProductViewModel>
    {
        ...
        public async Task<IActionResult> AddToCart(Guid id)
        {
            ...
            if (string.IsNullOrEmpty(opportunityId))
            {
                ...
                {
                    //LeadID = new Guid(HttpContext.User.FindFirst("http://schemas.microsoft.com/identity/claims/objectidentifier")?.Value),
                    ...
                    //CreatedBy = new Guid(HttpContext.User.FindFirst("http://schemas.microsoft.com/identity/claims/objectidentifier")?.Value),
                    //ModifiedBy = new Guid(HttpContext.User.FindFirst("http://schemas.microsoft.com/identity/claims/objectidentifier")?.Value),
                    StatusCode = 1
                };
